...
import com.dcrp.app.service.Test2KafkaProducer;
import com.dcrp.app.service.Test2KafkaConsumer;
...
public class Test2KafkaResourceIT {
    ...
    @Autowired
    private Test2KafkaProducer producer;

    @Autowired
    private Test2KafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        Test2KafkaResource kafkaResource = new Test2KafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/test-2-kafka/publish?message=test"))
